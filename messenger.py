...
import json
import re
from TransiBot.transitbot import classifier 
from TransiBot import regular as reg
from TransiBot.config import CONFIG
from fbmq import Attachment, Template, QuickReply, NotificationType
from TransiBot.fbpage import page
...
def send_message(recipient_id, text):
    ...
    #Aquí termina la sección para la programación del lenguaje antes del quick_reply
...
@page.callback(['OPCION_DE_TRANSITO'], types=["POSTBACK"])
